...
class SockClient {
  ...
  public static void main (String args[]) {
    ...
    try {
      ...
      while (requesting) {
        System.out.println("What would you like to do: 1 - echo, 2 - add, 3 - addmany, 4 - string concatenation, 5 - charcount (0 to quit)");
        ...
        switch(choice) {
          ...
          case 3: // addmany
            ...
            json.put("nums", array);
            break;
          case 4: // stringconcatenation
            System.out.println("Choose stringconcatenation, enter first string:");
            String string1 = scanner.nextLine();
            System.out.println();
            String string2 = scanner.nextLine();

            json.put("type", "stringconcatenation");
            json.put("string1", string1);
            json.put("string2", string2);
            break;
          case 5: // charcount here
            System.out.println("Choose charcount, do you want to find a specific character? (true/false)");
            boolean findchar = Boolean.parseBoolean(scanner.nextLine());

            json.put("type", "charcount");
            json.put("findchar", findchar);
            if (findchar) {
        ...
        if (res.getBoolean("ok")){
          ...
          } else if (res.getString("type").equals("stringconcatenation")) { // added
